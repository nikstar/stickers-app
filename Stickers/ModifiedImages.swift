...
//                workImage = BackgroundEffect.apply(to: workImage, config: sticker.background)
//            case .resize:
//                workImage = Resize.apply(to: workImage)
//            case let .addText(text: text, position: position, font: font, color: color):
//                workImage = AddTextEffect.apply(to: workImage, text: text, position: position, font: font, color: color)
//            }
//        }
